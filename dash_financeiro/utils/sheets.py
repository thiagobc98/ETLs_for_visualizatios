...
class Sheets: 
    ...
    def upload_to_sheets(self, df: pd.DataFrame, pagina_sheets: str) -> None:
        ...
        print(f"{total_celulas}\n")
        if total_celulas > 10_000_000:
            print(f"Erro: O DataFrame contém {total_celulas} células, excedendo o limite de 10.000.000!")
            return  # Evita o upload se ultrapassar o limite
