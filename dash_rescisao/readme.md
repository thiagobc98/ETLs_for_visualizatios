...
## Dependencies
Para executar o Dash Rescisão, você precisará das seguintes dependências:
- **Variáveis de Ambiente:**
  ...
  - `CODE_SHEETS_DASH_RESCISAO`: O código das planilhas.

## Links
- **Dashboard:** [Looker Studio Rescisão].
- **Dados:** [Planilha de dados para Dashboard Rescisão].

## Atualização
- **Frequência:** Atualização todas às segundas-feiras na parte da manhã
- **Modo:** Script Python `dash_rescisao\main.py`
...
## Extração de Dados
### Planilha de Rescisão --> Pedir acesso ao Pedro Salles
